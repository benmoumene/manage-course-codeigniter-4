<div class="container">
    <div class="row">
        ...
        <div class="col-md-4">
            <p class="font-weight-bold"><?=$this->lang->line('field_course_plan_date_begin')?></p>
            <p><?=$course_plan->date_begin?></p>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <p class="bg-primary text-white"><?=$this->lang->line('field_linked_competence_domains')?></p>
        </div>
        <div class="col-md-12">
            <table class="table table-hover">
            <thead>
                <tr>
                    <th><span class="font-weight-bold"><?=$this->lang->line('field_competence_domains_symbols')?></span></th>
                    <th><span class="font-weight-bold"><?=$this->lang->line('field_competence_domains_names')?></span></th>
                </tr>
            </thead>
            <tbody><?php
