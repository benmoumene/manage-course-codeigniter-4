<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <thead>
                <tr>
                    <th><span class="font-weight-bold"><?=lang('user_lang.field_operational_competences_symbols')?></span></th>
                    <th><span class="font-weight-bold"><?=lang('user_lang.field_operational_competences_names')?></span></th>
                </tr>
            </thead>
            <tbody><?php
